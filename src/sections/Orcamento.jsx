  ...
  return (
    <section className="py-8 px-5 xl:px-14 mt-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-5 lg:gap-7 mt-14 md:mt-20">
        <div className="flex flex-col md:justify-center md:items-center gap-7">
          <div className="p-4 md:p-5 rounded-full bg-neutral-100 shadow-md w-fit">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-5  mt-10">
        <a href="#contato">
